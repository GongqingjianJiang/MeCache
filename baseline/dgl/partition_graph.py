...
sys.path.append(os.path.join(os.path.dirname(__file__), "../heta"))
...
if __name__ == "__main__":
    ...
    start = time.time()
    g, num_classes, target_node_type, list_of_metapaths, reverse_edge_type_prefix = load_dataset(args.dataset, args.root, complete_missing_feats=args.complete_missing_feats)
    print("num_classes: ", num_classes)
    metatree = MetaTree(g, target_node_type, list_of_metapaths, reverse_edge_type_prefix,3)
